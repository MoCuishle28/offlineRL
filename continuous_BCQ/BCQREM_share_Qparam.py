...
class Critic(nn.Module):
	...
	def compute_q(self, state, action, l3, l6):
	...
	def compute_q1(self, state, action, l3):
		q1 = F.relu(self.l1(torch.cat([state, action], 1)))
		q1 = F.relu(self.l2(q1))
		q1 = l3(q1)
		return q1
	...
	def forward(self, state, action):
		# head 1
		q1_1, q2_1 = self.compute_q(state, action, self.l3_1, self.l6_1)
		# head 2
		q1_2, q2_2 = self.compute_q(state, action, self.l3_2, self.l6_2)
		# head 3
		q1_3, q2_3 = self.compute_q(state, action, self.l3_3, self.l6_3)
		# head 4
		q1_4, q2_4 = self.compute_q(state, action, self.l3_4, self.l6_4)
		# head 5
		q1_5, q2_5 = self.compute_q(state, action, self.l3_5, self.l6_5)
	...
	def q1(self, state, action):
		# head 1
		q1_1 = self.compute_q1(state, action, self.l3_1)
		# head 2
		q1_2 = self.compute_q1(state, action, self.l3_2)
		# head 3
		q1_3 = self.compute_q1(state, action, self.l3_3)
		# head 4
		q1_4 = self.compute_q1(state, action, self.l3_4)
		# head 5
		q1_5 = self.compute_q1(state, action, self.l3_5)
